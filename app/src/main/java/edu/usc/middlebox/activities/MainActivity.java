...
//            dismissDialog(progress_bar_type);
    ...
    class CheckMiddlebox extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            long average433 = 0;
            String average80RTT = "";
            String average443RTT = "";

            int i = 0;
            while(i < 50)
            {
                long start_time80, end_time80, diff_time80;
                long start_time443, end_time443, diff_time443;
                try {
                    start_time80 = System.currentTimeMillis();
                    Socket client80 = new Socket("74.125.225.147",80);
                    diff_time80 = System.currentTimeMillis() - start_time80;
                    average80 += diff_time80;
                    average80RTT +=  "," + diff_time80;

                    start_time443 = System.currentTimeMillis();
                    Socket client443 = new Socket("74.125.225.147",443);
                    diff_time443 = System.currentTimeMillis() - start_time443;
                    average433 += diff_time443;
                    average443RTT += "," + diff_time443;
                } catch (UnknownHostException e) {
            ...
            try {
                if (average433 > average80)
                    ...
                    object.put("result", 0);
                object.put("metadata", average433 + "|" + average80 + "|" + average443RTT + "|" + average80RTT);
            } catch (JSONException e) {
                e.printStackTrace();
            }
            return object.toString();
